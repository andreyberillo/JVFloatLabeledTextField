Pod::Spec.new do |s|
  ...
  s.homepage     = "https://github.com/andreyberillo/JVFloatLabeledTextField"
  ...
  s.source       = { :git => "https://github.com/andreyberillo/JVFloatLabeledTextField.git", :tag => s.version.to_s }
  s.platform     = :ios
